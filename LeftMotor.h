...
class LeftMotor {
private:
    int in1Pin = 26;     // First direction control pin
    int in2Pin = 27;     // Second direction control pin
    int pwmPin = 25;     // PWM speed control pin
    int pwmChannel = 0; // ESP32 LEDC PWM channel
